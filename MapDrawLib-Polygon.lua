...
local function DrawTriangle(parent,tri,x1,y1,x2,y2,x3,y3)
    ...
    -- some parts here are from avr addon <3
    local dx=maxx-minx
    local dy=maxy-miny
    if dx==0 or dy==0 then return end
